    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 5))) }}"><a href="{{ route('categories.show', 5) }}">记录</a></li>
            </ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        @endcan
                            ...
                            <li>
                                <a href="{{ route('users.show',Auth::id()) }}"><span class="glyphicon glyphicon-user" aria-hidden></span>
                                个人中心
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                             ...
                                             <span class="glyphicon glyphicon-log-out" aria-hidden></span>
